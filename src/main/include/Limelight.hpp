...
public:
    enum class LED_Mode { Keep_Current = 0, Force_Off, Blink, Force_On };
    enum class Camera_Mode { Vision_Processor = 0, Driver_Camera };
    enum class Stream_Mode { Standard = 0, PiP_Main, PiP_Secondary };
    enum class Snapshot_Mode { OFF = 0, ON };
